[当前笔记配套的视频教程](https://www.bilibili.com/video/BV1Kr4y1i7ru/?spm_id_from=333.337.search-card.all.click&vd_source=54b92ea953eb0a7281545e66410fc2f5)
# 基础篇
...
![结构图](https://vite-press.oss-cn-beijing.aliyuncs.com/database/MySQL体系结构.png "结构图")  
![层级描述](https://vite-press.oss-cn-beijing.aliyuncs.com/database/MySQL体系结构层级含义.png "层级描述")  
...
InnoDB 逻辑存储结构：  
![InnoDB逻辑存储结构](https://vite-press.oss-cn-beijing.aliyuncs.com/database/逻辑存储结构.png "InnoDB逻辑存储结构")  
...
![二叉树](https://vite-press.oss-cn-beijing.aliyuncs.com/database/二叉树.png "二叉树")

二叉树形成链表的缺点可以用红黑树来解决：
![红黑树](https://vite-press.oss-cn-beijing.aliyuncs.com/database/红黑树.png "红黑树")
红黑树也存在大数据量情况下，层级较深，检索速度慢的问题。

为了解决上述问题，可以使用 B-Tree 结构。
B-Tree (多路平衡查找树) 以一棵最大度数（max-degree，指一个节点的子节点个数）为5（5阶）的 b-tree 为例（每个节点最多存储4个key，5个指针）

![B-Tree结构](https://vite-press.oss-cn-beijing.aliyuncs.com/database/B-Tree结构.png "B-Tree结构")
...
![MySQL B+Tree 结构图](https://vite-press.oss-cn-beijing.aliyuncs.com/database/结构图.png "MySQL B+Tree 结构图")
...
![大致原理](https://vite-press.oss-cn-beijing.aliyuncs.com/database/原理图.png "大致原理")
![演示图](https://vite-press.oss-cn-beijing.aliyuncs.com/database/演示图.png "演示图")
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/pre.png "索引流程")
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/uion.png)
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/keySort.png)
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic.png )

Buffer Pool：缓冲池是主内存中的一个区域，里面可以缓存磁盘上经常操作的真实数据，在执行增删改查操作时，先操作缓冲池中的数据（若缓冲池没有数据，则从磁盘加载并缓存），然后再以一定频率刷新到磁盘，从而减少磁盘I0，加快处理速度。

![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic2.png )
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic3.png )
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic4.png )
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic5.png )


磁盘架构：
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic6.png )
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic7.png )
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/artic8.png )
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/MVCC.png )
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/MVCCList.png )

如何确定返回哪一个版本 这是由read view决定返回 undo log 中的哪一个版本。

![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/readview0.png )
...
![images](https://vite-press.oss-cn-beijing.aliyuncs.com/database/readview.png )
